...
@testset "ConEc: Basic functionality" begin
    ...
    try
        ...
        w2v = train_cbow(
            tokens; dim = 10, window = 2, epochs = 3, lr = 0.1,
...
@testset "ConEc: Embedding computation" begin
    ...
    try
        tokens = split(GLOBAL_CORPUS_TEXT)
        w2v = train_cbow(
            tokens; dim = 5, window = 1, epochs = 5, lr = 0.2,
        ...
        local_embs = conec_embeddings_for_file(
            conec_model, local_path;
